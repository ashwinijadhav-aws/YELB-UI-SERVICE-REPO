...
echo "value of DOCKER_IMAGE_NAME is $DOCKER_REPO_NAME"
...
ecr_repo_name=$DOCKER_REPO_NAME"-ecr-repo"
...
image_name=$SDLC_ENVIRONMENT-$DOCKER_REPO_NAME-$MODULE-$CODEBUILD_BUILD_NUMBER
...
docker build -t ${image_name} $CODEBUILD_SRC_DIR/YELB-APP/yelb-appserver/
